package com.esprit.gitesprit.cloudstorage.infrastructure.adapter;
...
import com.esprit.gitesprit.exception.CloudStorageException;
...
public class AzureAdapter implements CloudStorage {
    ...
    public Blob uploadFile(MultipartFile file) {
        if (file.getSize() > 5242880) {
            throw new CloudStorageException(CloudStorageException.CloudStorageExceptionType.FILE_SIZE_LIMIT_EXCEEDED);
        }
    ...
    public Blob uploadImage(MultipartFile file) {
        if (file.getSize() > 5242880) {
            throw new CloudStorageException(CloudStorageException.CloudStorageExceptionType.IMAGE_SIZE_LIMIT_EXCEEDED);
        }
