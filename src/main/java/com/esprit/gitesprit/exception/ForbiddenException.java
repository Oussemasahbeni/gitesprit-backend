...
public class ForbiddenException extends ApplicationException {
    ...
    protected ForbiddenException(ExceptionType type, Throwable cause, Object[] valueParams, Object... keyParams) {
    ...
    protected ForbiddenException(ExceptionType type, String message, Throwable cause, Object... keyParams) {
    ...
    public enum ForbiddenExceptionType implements ExceptionType {
        GENERIC("error.server.forbidden.generic.title", "error.server.forbidden.generic.msg", "Forbidden error 403"),
