...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleAccessDeniedException(AccessDeniedException ex) {
        ...
        return buildResponseEntity(
                new ExceptionResponse("Access denied", "error.server.access.denied.msg", ex), HttpStatus.FORBIDDEN);
    }
    ...
    public ResponseEntity<Object> handleGenericException(GenericException ex) {
        ...
        return buildResponseEntity(
                new ExceptionResponse(ex.getTitleKey(), ex.getMessageKey(), ex), HttpStatus.INTERNAL_SERVER_ERROR);
    }
