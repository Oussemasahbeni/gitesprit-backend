...
public class GenericException extends ApplicationException {
    ...
    protected GenericException(ExceptionType type, Throwable cause, Object[] valueParams, Object... keyParams) {
    ...
    protected GenericException(ExceptionType type, String message, Throwable cause, Object... keyParams) {
