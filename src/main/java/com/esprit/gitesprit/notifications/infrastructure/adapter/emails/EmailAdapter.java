package com.esprit.gitesprit.notifications.infrastructure.adapter.emails;

import com.esprit.gitesprit.notifications.domain.enums.EmailType;
import com.esprit.gitesprit.notifications.domain.port.output.Emails;
...
public class EmailAdapter implements Emails {
    ...
    @Recover
    public void recover(MessagingException e, String emailRecipient, String code, EmailType emailType) {
