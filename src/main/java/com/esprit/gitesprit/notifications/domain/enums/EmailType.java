package com.esprit.gitesprit.notifications.domain.enums;
...
public enum EmailType {
    ...
    NEWS_LETTER_CONFIRMATION("News Letter Confirmation", "newsLetterConfirmation", "/newsletter/confirm-subscription"),
