package com.esprit.gitesprit.config.websocket;
...
@AllArgsConstructor
@Order(Ordered.HIGHEST_PRECEDENCE + 99) // Ensure that this configuration is loaded before the security configuration
